...
//=============================================================================
class SuperShockColourGoldBeam extends Effects;
...
#exec TEXTURE IMPORT NAME=energy_gold FILE=MODELS\energy_gold.pcx GROUP=Effects

#exec MESHMAP SETTEXTURE MESHMAP=SShockbm NUM=1 TEXTURE=energy_gold
...
{
	local SuperShockColourGoldBeam r;
	
	if (NumPuffs>0)
	{
		r = Spawn(class'SuperShockColourGoldBeam',,,Location+MoveAmount);
...
defaultproperties
{
      ...
      Texture=Texture'SuperShockTeamColour.Effects.energy_gold'
