...
//=============================================================================
class SuperShockColourRedBeam extends Effects;
...
#exec TEXTURE IMPORT NAME=energy_red FILE=MODELS\energy_red.pcx GROUP=Effects

#exec MESHMAP SETTEXTURE MESHMAP=SShockbm NUM=1 TEXTURE=energy_red
...
{
	local SuperShockColourRedBeam r;
	
	if (NumPuffs>0)
	{
		r = Spawn(class'SuperShockColourRedBeam',,,Location+MoveAmount);
...
defaultproperties
{
      ...
      Texture=Texture'SuperShockTeamColour.Effects.energy_red'
