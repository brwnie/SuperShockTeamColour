...
//=============================================================================
class SuperShockColourBlueBeam extends Effects;
...
#exec TEXTURE IMPORT NAME=energy_blue FILE=MODELS\energy_blue.pcx GROUP=Effects

#exec MESHMAP SETTEXTURE MESHMAP=SShockbm NUM=1 TEXTURE=energy_blue
...
{
	local SuperShockColourBlueBeam r;
	
	if (NumPuffs>0)
	{
		r = Spawn(class'SuperShockColourBlueBeam',,,Location+MoveAmount);
...
defaultproperties
{
      ...
      Texture=Texture'SuperShockTeamColour.Effects.energy_blue'
