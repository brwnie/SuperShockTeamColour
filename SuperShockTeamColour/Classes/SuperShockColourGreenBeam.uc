...
//=============================================================================
class SuperShockColourGreenBeam extends Effects;
...
#exec TEXTURE IMPORT NAME=energy_green FILE=MODELS\energy_green.pcx GROUP=Effects

#exec MESHMAP SETTEXTURE MESHMAP=SShockbm NUM=1 TEXTURE=energy_green
...
{
	local SuperShockColourGreenBeam r;
	
	if (NumPuffs>0)
	{
		r = Spawn(class'SuperShockColourGreenBeam',,,Location+MoveAmount);
...
defaultproperties
{
      ...
      Texture=Texture'SuperShockTeamColour.Effects.energy_green'
