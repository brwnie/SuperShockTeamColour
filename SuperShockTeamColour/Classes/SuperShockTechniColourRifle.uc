//=============================================================================
// SuperShockTechniColourRifle.
//=============================================================================
class SuperShockTechniColourRifle extends ShockRifle;
...
{
	local SuperShockColourGreenBeam GreenSmoke;
	local SuperShockColourRedBeam RedSmoke;
	local SuperShockColourGoldBeam GoldSmoke;
	local SuperShockColourBlueBeam BlueSmoke;
	local SuperShockColourWhiteBeam WhiteSmoke;
	...
	switch (Pawn(Owner).PlayerReplicationInfo.Team) {
		case 0:
			RedSmoke = Spawn(class'SuperShockColourRedBeam',,,SmokeLocation,SmokeRotation);
			RedSmoke.MoveAmount = DVector/NumPoints;
			RedSmoke.NumPuffs = NumPoints - 1;
			break;
		case 1:
			BlueSmoke = Spawn(class'SuperShockColourBlueBeam',,,SmokeLocation,SmokeRotation);
			BlueSmoke.MoveAmount = DVector/NumPoints;
			BlueSmoke.NumPuffs = NumPoints - 1;	
			break;
		case 2:
			GreenSmoke = Spawn(class'SuperShockColourGreenBeam',,,SmokeLocation,SmokeRotation);
			GreenSmoke.MoveAmount = DVector/NumPoints;
			GreenSmoke.NumPuffs = NumPoints - 1;	
			break;
		case 3:
			GoldSmoke = Spawn(class'SuperShockColourGoldBeam',,,SmokeLocation,SmokeRotation);
			GoldSmoke.MoveAmount = DVector/NumPoints;
			GoldSmoke.NumPuffs = NumPoints - 1;	
			break;
		default:
			WhiteSmoke = Spawn(class'SuperShockColourWhiteBeam',,,SmokeLocation,SmokeRotation);
			WhiteSmoke.MoveAmount = DVector/NumPoints;
			WhiteSmoke.NumPuffs = NumPoints - 1;	
			break;
	}
...
defaultproperties
{
      ...
      PickupMessage="You got the Super Shock Technicolour Rifle."
      ItemName="Supershock Technicolour Shock Rifle"
