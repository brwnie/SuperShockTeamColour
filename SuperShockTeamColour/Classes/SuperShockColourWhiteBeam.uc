//=============================================================================
// SuperShockColourBeam.
//=============================================================================
class SuperShockColourWhiteBeam extends Effects;
...
#exec TEXTURE IMPORT NAME=energy_white FILE=MODELS\energy_white.pcx GROUP=Effects

#exec MESHMAP SETTEXTURE MESHMAP=SShockbm NUM=1 TEXTURE=energy_white
...
{
	local SuperShockColourWhiteBeam r;
	
	if (NumPuffs>0)
	{
		r = Spawn(class'SuperShockColourWhiteBeam',,,Location+MoveAmount);
...
defaultproperties
{
      ...
      Texture=Texture'SuperShockTeamColour.Effects.energy_white'
